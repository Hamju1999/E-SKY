...
class _TrackingPageState extends State<TrackingPage> {
  final List<Location> locations = [
    Location('Manufacturer Factory', DateTime(2020, 11, 1, 5, 23, 4),
        showHour: false, isHere: false, passed: true),
    Location('Manufacturer Storage', DateTime(2020, 11, 2, 5, 23, 4),
        showHour: false, isHere: false, passed: true),
    Location(
      'Company Storage',
      DateTime(2020, 11, 3, 5, 23, 4),
      showHour: false,
      isHere: true,
    ),
    Location(
      'Retail Shop',
      DateTime(2020, 11, 5, 10, 30, 4),
      showHour: true,
      isHere: false,
    ),
  ];

  String selectedProduct = 'Dell 3050';
    ...
    return Container(
      decoration: BoxDecoration(
          ...
          image: DecorationImage(
              image: AssetImage('assets/images/Group 444.png'), fit: BoxFit.contain)),
      child: Container(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: ConstrainedBox(
                        ...
                        child: Theme(
                          data:
                          ThemeData(primaryColor: Color(0xFF5EB024), fontFamily: 'Kalam',),
                          child: Stepper(
