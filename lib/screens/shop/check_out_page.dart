...
import 'package:e_sky/screens/address/add_address_page.dart';
import 'package:e_sky/screens/payment/unpaid_page.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Checkout',
          style: TextStyle(
              color: Color(0xFF43ad53), fontWeight: FontWeight.w500, fontSize: 18.0),
        ),
      ),
      body: LayoutBuilder(
